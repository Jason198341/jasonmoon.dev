...
const CATEGORIES = [
  ...
  { key: 'tech', label: 'Tech', labelKo: '기술' },
  { key: 'marketing', label: 'Marketing', labelKo: '마케팅' },
  { key: 'writing', label: 'Writing', labelKo: '글쓰기' },
  { key: 'design', label: 'Design', labelKo: '디자인' },
  { key: 'media', label: 'Media', labelKo: '미디어' },
  { key: 'data', label: 'Data', labelKo: '데이터' },
  { key: 'education', label: 'Education', labelKo: '교육' },
  { key: 'career', label: 'Career', labelKo: '커리어' },
  { key: 'finance', label: 'Finance', labelKo: '금융' },
  { key: 'legal', label: 'Legal', labelKo: '법률' },
  { key: 'professional', label: 'Professional', labelKo: '전문직' },
  { key: 'wellness', label: 'Wellness', labelKo: '건강' },
  { key: 'lifestyle', label: 'Lifestyle', labelKo: '라이프' },
  { key: 'parenting', label: 'Parenting', labelKo: '육아' },
  { key: 'productivity', label: 'Productivity', labelKo: '생산성' },
  { key: 'content', label: 'Content', labelKo: '콘텐츠' },
  { key: 'social', label: 'Social', labelKo: 'SNS' },
...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  tech: 'text-sky-400 bg-sky-500/10 border-sky-500/20',
  ...
  design: 'text-fuchsia-400 bg-fuchsia-500/10 border-fuchsia-500/20',
  media: 'text-rose-400 bg-rose-500/10 border-rose-500/20',
  data: 'text-indigo-400 bg-indigo-500/10 border-indigo-500/20',
  education: 'text-blue-400 bg-blue-500/10 border-blue-500/20',
  career: 'text-lime-400 bg-lime-500/10 border-lime-500/20',
  ...
  lifestyle: 'text-green-400 bg-green-500/10 border-green-500/20',
  parenting: 'text-pink-300 bg-pink-400/10 border-pink-400/20',
  productivity: 'text-zinc-300 bg-zinc-500/10 border-zinc-500/20',
